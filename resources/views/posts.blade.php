        ...
        <div class="card mb-3">
            @if ($posts[0]->image)
                <div class="" style="width: 1200px; height: 400px;">
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" style="object-fit: cover;" alt="">
                </div>
            @else
            ...
            <div class="card-body text-center">
                <h3 class="card-title"><a href="/posts/{{ $posts[0]->slug }}"
                    ...
                    <p class="card-text"><small class="text-muted">Tanggal postingan:
                            {{ date('d-m-Y', strtotime($posts[0]->created_at)) }}</small></p>
            </div>
        </div>
                ...
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            @if ($post->image)
                                <img src="{{ asset('storage/' . $post->image) }}" style="width: 500px; height: 500px;"
                                    alt="">
                            @else
